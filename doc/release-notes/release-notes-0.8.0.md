Hellebit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/hellebit/files/Hellebit/hellebit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Hellebit
...
New/changed settings (command-line or hellebit.conf file)
--------------------------------------------------------
