Hellebit Core version 0.9.4 is now available from:

  https://hellebit.org/bin/0.9.4/
...
this update is incompatible with the Hellebit system and could lead to consensus
forks.

Hellebit Core released binaries from https://hellebit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~hellebit/+archive/ubuntu/hellebit
- A third-party or self-compiled Hellebit Core

upgrade to Hellebit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
