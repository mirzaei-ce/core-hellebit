Hellebit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/hellebit/files/Hellebit/hellebit-0.5.4/
...
http://gitorious.org/hellebit/hellebitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Hellebit-Qt notifications under Growl 1.3.
Increase required age of Hellebit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxHellebit properly when installing Hellebit-Qt over it. (Windows)
