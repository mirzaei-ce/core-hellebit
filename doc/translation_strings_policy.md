...
This document provides guidelines for internationalization of the Hellebit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `hellebit_en.ts` remains unchanged.
