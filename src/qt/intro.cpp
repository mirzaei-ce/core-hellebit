...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/hellebit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Hellebit Core"),
     ...
     * override -datadir in the hellebit.conf file in the default data directory
     * (to be consistent with hellebitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
