...
#ifndef HELLEBIT_QT_HELLEBITUNITS_H
#define HELLEBIT_QT_HELLEBITUNITS_H
...
/** Hellebit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class HellebitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit HellebitUnits(QObject *parent);

    /** Hellebit units.
      @note Source: https://en.hellebit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        HBT,
...
typedef HellebitUnits::Unit HellebitUnit;

#endif // HELLEBIT_QT_HELLEBITUNITS_H
