...
#ifndef HELLEBIT_TEST_SCRIPTNUM10_H
#define HELLEBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Hellebit Core 0.10.0, for cross-comparison.
 */
public:
