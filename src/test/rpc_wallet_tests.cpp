...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CHellebitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CHellebitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CHellebitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CHellebitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CHellebitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CHellebitAddress(arr[0].get_str()).Get() == demoAddress.Get());
