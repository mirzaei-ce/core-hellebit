...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Hellebit Core hellebit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  hellebit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hellebit transaction") + "\n" +
              "  hellebit-tx [options] -create [commands]   " + _("Create hex-encoded hellebit transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hellebit transaction
