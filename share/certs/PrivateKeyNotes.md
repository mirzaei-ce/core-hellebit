...
unlocked to sign the Hellebit-Qt.app bundle.
...
allowing somebody to distribute a Hellebit-Qt.app or hellebit-qt-setup.exe with a valid
...
that the hellebit-qt.exe file inside the installer had not been tampered with.
